...
public class ContasApagarBean implements Serializable {
	...
	private void carregarLista() throws SQLException {
		...
		listaFinanceiros = listaService.contasApagar();
		pesquisarFinanceiros = listaService.contasApagar();
	}
	...
	public void gerarRelatorio() {
		...
		try {
			...
			listaFinanceiros = listaService.contasApagar();
			relatorioService.gerarRelatorioApagar(listaFinanceiros, parametros, "apagar");
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	private void carregarValor() throws SQLException {
		...
		despesa = listaService.getTotalApagar();
	}
