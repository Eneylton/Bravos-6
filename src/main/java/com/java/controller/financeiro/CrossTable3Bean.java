...
@Named
@ViewScoped
public class CrossTable3Bean implements Serializable {
	...
	public void gerarRelatorioReceitaBanco() {

		try {
			HashMap<String, Object> parametros = new HashMap<String, Object>();
			listarCrossTable = crossTableService.listarReceitaBanco();
			relatorioService.gerarRelatorioReceitaBanco(listarCrossTable, parametros, "receitaBanco");
		} catch (Exception e) {
			e.printStackTrace();
		}
