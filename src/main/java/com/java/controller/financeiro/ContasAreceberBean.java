...
import com.java.service.ListaService;
...
@Named
@ViewScoped
public class ContasAreceberBean implements Serializable {
	...
	private void carregarLista() throws SQLException {
		...
		listaFinanceiros = listaService.contasAreceber();
		pesquisarFinanceiros = listaService.contasAreceber();
	}
	...
	public void gerarRelatorio() {
		...
		try {
			...
			listaFinanceiros = listaService.contasAreceber();
			relatorioService.gerarRelatorioAreceber(listaFinanceiros, parametros, "receber");
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	private void carregarValor() throws SQLException {
		...
		despesa = listaService.getTotalAreceber();
	}
