...
@Named
@ViewScoped
public class CrossTable2Bean implements Serializable {
	...
	public void gerarRelatorioDespesa() {
		...
		try {
			...
			listarCrossTable = crossTableService.listarDespesa();
			relatorioService.gerarRelatorioDespesa(listarCrossTable, parametros, "despesa");
		} catch (Exception e) {
			e.printStackTrace();
		}
