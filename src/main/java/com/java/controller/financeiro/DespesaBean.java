...
public class DespesaBean implements Serializable {
	...
	private void carregarLista() throws SQLException {
		...
		listaFinanceiros = listaService.retornoDespesa();
		pesquisarFinanceiros = listaService.retornoDespesa();
	}
	...
	public void gerarRelatorio() {
		...
		try {
			...
			listaFinanceiros = listaService.retornoDespesa();
			relatorioService.gerarDespesas(listaFinanceiros, parametros, "despesas");
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	private void carregarValor() throws SQLException {
		...
		despesa = listaService.getTotalDespesa();
	}
