...
@Named
@ViewScoped
public class CrossTableBean implements Serializable {
	...
	public void consultar() throws SQLException {
		...
		listarCrossTable = crossTableService.listarReceita();
	...
	public void gerarRelatorioReceita() {
		...
		try {
			...
			listarCrossTable = crossTableService.listarReceita();
			relatorioService.gerarRelatorioReceita(listarCrossTable, parametros, "receita");
		} catch (Exception e) {
			e.printStackTrace();
		}
